// node forum <puerto> <ipdmserver> <puertodmserver>
...
sock.on('message', function(msgStr){
		console.log("Event: add message: " + msgStr);
...
subscriber.on('message', function(msg) {
  ...
  console.log("Verdadero mensaje subscriber " + msg[1]);
    ...
    sock.on('new user', function (usr, pas) {
  	...
  	sock.on ('get user list', function () {
  		dm.getUserList (function (list) {
	  		console.log("Event: get user list  --> " + list);
